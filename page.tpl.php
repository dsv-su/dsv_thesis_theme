...
<header id="navbar" role="banner" class="<?php print $navbar_classes; ?>">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <img src="/sites/all/themes/custom/dsv_thesis_theme/img/thesisinfo.png" class="logo pull-left" alt="Thesis Info"/>
      </a>
      ...
      <div class="navbar-collapse collapse">
        <nav role="navigation">
          ...
          <?php if (!empty($page['navigation_search'])): ?>
            <?php print render($page['navigation_search']); ?>
          <?php endif; ?>
...
<div class="main-container container">
  ...
  <div class="row">
    ...
    <section<?php print $content_column_class; ?>>
      ...
      <section id="block-system-lower" class="block block-system clearfix">
    ...
    <?php if (!empty($page['sidebar_menu']) || !empty($page['sidebar_second'])): ?>
      <aside class="col-sm-3" role="complementary">
        <?php if (!empty($page['sidebar_menu'])): ?>
          <?php print render($page['sidebar_menu']); ?>
        <?php endif; ?>
